    ...
    <div id="project__content">
      ...
      <Row className="project__overview">
        <Col sm={12}>
          ...
          <h5>Outcome</h5>
          <p>The design delivered was really well received, Mindful stakeholders felt so strong about the solutions suggested that have already implemented the majority of it. See the Mindful website here <a href="https://lesalon.com" rel="noopener  noreferrer" target="_blank" >https:&#47;&#47;lesalon.com</a></p>
          <h5>Tools</h5>
